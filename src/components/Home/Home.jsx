    ...
    <div className="main">
      ...
      <div className="container my-3 bg-blue border-25">
        <div class="d-flex flex-row mx-4 py-3 text-center">
          <h3 className=" text-white">Pilih Jenjang Pendidikan : </h3>
          <a
            href=""
            className="btn btn-primary m-3 px-3 fs-4 w-25 rounded-pill fw-bold text-black bg-white"
          >
            SD
          </a>
          <a
            href=""
            className="btn btn-primary m-3 px-5 fs-4 w-25 rounded-pill fw-bold text-black bg-white"
          >
            SMP
          </a>
          <a
