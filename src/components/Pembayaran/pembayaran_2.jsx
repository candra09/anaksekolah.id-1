    ...
    <div className=" container">
      <div className="row ">
        <div className=" col-lg-9 mb-2">
          <div
            className="card p-3  align-items-center justify-content-center"
            style={{ backgroundColor: "#2F5493" }}
          >
            <h4 style={{ fontWeight: "bold", color: "white" }}>
              Keterangan Paket Kelas
            </h4>
          </div>
          <div className="card">
            ...
            <div
              className="card-judul align-items-center justify-content-center"
              style={{ fontSize: 24 }}
            >
            ...
            <div className="card-body py-4 px-4 align-items-center justify-content-center">
              <div className="mb-1 text-size-4">
                <p>
                  ...
                  Vestibulum facilisis, nunc at imperdiet tincidunt, diam mi
                  consequat dui, a ornare urna velit vitae urna. Donec ut risus
                  eget ipsum dignissim vulputate. Nullam mattis eleifend semper.
                  Sed lobortis nisl id ipsum viverra porta. Nullam tincidunt
                  vulputate lectus non maximus. Lorem ipsum dolor sit amet,
                  consectetur adipiscing elit. Aliquam volutpat at orci sed
                  vulputate.
                </p>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <div>
                <div className="row card-body">
                  <div className="dropdown-pembayaran  text-center">
                    ...
                    <a href="/transaksi" style={{ textDecoration: "none" }}>
                      <button
                        type="button"
                        class="btn btn-primary btn-submit mb-2"
          ...
          >
            <div className="row card-body">
              ...
              <div>
                ...
                <h6 style={{ paddingLeft: "53px" }}>Rp. 100.000</h6>
