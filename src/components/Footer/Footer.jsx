            ...
            <div className="row">
              <div className="col-md">
                ...
                <p className="w-100 text-justify">
                  ...
                  Officiis possimus repellendus dolore explicabo voluptatum sit
                  minus molestiae!
                </p>
                <a
                  href="#"
              ...
              <div className="col-md">
                <div className="my-5 py-1">
                  ...
                  <div className="">
                    <a
                      href=""
                      className="btn btn-light btn-lg text-black my-2 text-lg-start w-100"
                    >
                    ...
                    <a
                      href=""
                      className="btn btn-light btn-lg text-black mt-2 text-lg-start w-100"
                    >
